...
## ⚠️ CRITICAL PREREQUISITE: SHIZUKU IS REQUIRED
...
## 🚀 Quick Start
1. Grant Shizuku permissions to Termux (MANDATORY).
2. Install dependencies: `pkg install python ollama termux-api git`
3. Start local LLM: `ollama run qwen2:0.5b` (keep running in background)
4. Wire ESP32 and plug into phone via USB OTG.
5. Run the brain: `python3 brain/main.py`
